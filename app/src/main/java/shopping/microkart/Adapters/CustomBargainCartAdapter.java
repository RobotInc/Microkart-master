...
public class CustomBargainCartAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final DatabaseReference statusref = FirebaseDatabase.getInstance().getReference().child("BargainCarts").child(bidid.get(position)).child("status");
                ...
                public void onClick(View v) {
                    ...
                    acceptoffer.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            DatabaseReference bargainpriceref = FirebaseDatabase.getInstance().getReference().child("BargainCarts").child(bidid.get(position)).child("bidValue");
                    ...
                    rejectoffer.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            DatabaseReference statusref = FirebaseDatabase.getInstance().getReference().child("BargainCarts").child(bidid.get(position)).child("status");                            statusref.setValue(4);
                            dialog.dismiss();
                            /** CUSTOM TOAST MESSAGE **/
                            Toast toast = Toast.makeText(context,"", Toast.LENGTH_SHORT);
                            View view = toast.getView();
