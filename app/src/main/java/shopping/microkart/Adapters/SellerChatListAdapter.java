...
public class SellerChatListAdapter extends BaseAdapter{
    ...
    ArrayList<DatabaseReference> Productrefs;
    String ImageURL;
    ArrayList<DatabaseReference> Statusrefs;
    Integer status;
    public SellerChatListAdapter(Context context,ArrayList<DatabaseReference> Productrefs, ArrayList<DatabaseReference> Statusrefs,ArrayList<String> ProductID){
