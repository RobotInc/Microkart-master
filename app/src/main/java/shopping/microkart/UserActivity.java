...
public class UserActivity extends AppCompatActivity
    ...
    DatabaseReference ProductRef = FirebaseDatabase.getInstance().getReference().child("productDisplay");
    ...
    DatabaseReference bargaincartRef = FirebaseDatabase.getInstance().getReference().child("BargainCarts");
    @Override
    ...
    private void UpdateCartCounterInFirebase() {
        DatabaseReference counterRef = FirebaseDatabase.getInstance().getReference().child("userData").child("counts").child("cartCount");
    ...
    private void UpdateBargainCartCounterInFirebase() {
        DatabaseReference counterRef = FirebaseDatabase.getInstance().getReference().child("userData").child("counts").child("boxCount");
    ...
    public void FirebaseCartCount(DatabaseReference ref){
    ...
    public void FirebaseBargainCartCount(DatabaseReference ref){
        ref.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
    ...
    public void CartButtonClick(int position, View v,ArrayList<ProductClass> ProductList , DatabaseReference ref){
    ...
    public void BargainButtonAlertDialog(Context context, final int position, View v, final ArrayList<ProductClass> ProductList , final DatabaseReference ref){
